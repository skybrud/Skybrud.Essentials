...
public static partial class NewtonsoftJsonObjectExtensions {
    ...
    /// <summary>
    /// Returns the unsigned 64-bit integer value of the property with the specified <paramref name="propertyName"/>.
    /// If a matching property isn't found, or the value doesn't match a valid unsigned 64-bit integer, an exception is
    /// thrown instead.
    /// </summary>
    /// <param name="json">The parent JSON object.</param>
    /// <param name="propertyName">The name of the property.</param>
    ...
    /// <param name="json">The parent JSON object.</param>
    /// <param name="propertyName">The name of the property.</param>
    /// <param name="callback">A callback function used for converting the unsigned 64-bit integer value to <typeparamref name="TResult"/>.</param>
    /// <returns>The unsigned 64-bit integer value.</returns>
    /// <exception cref="JsonPropertyNotFoundException">If a property matching <paramref name="propertyName"/> isn't found.</exception>
    /// <exception cref="JsonException">If the property is found, but the value doesn't match an unsigned 64-bit integer.</exception>
