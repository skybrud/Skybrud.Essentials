...
public static partial class StringExtensions {
    ...
    /// <returns><see langword="true"/> if <paramref name="input"/> matches a single-precision floating-point number
    /// (<see cref="float"/>); otherwise <see langword="false"/>.</returns>
    ...
    /// </summary>
    /// <param name="input">The string to validate.</param>
    /// <param name="result">The converted value if the conversion was successful; otherwise <see langword="null"/>.</param>
    /// <returns><see langword="true"/> if <paramref name="input"/> matches a single-precision floating-point number
    /// (<see cref="float"/>); otherwise <see langword="false"/>.</returns>
