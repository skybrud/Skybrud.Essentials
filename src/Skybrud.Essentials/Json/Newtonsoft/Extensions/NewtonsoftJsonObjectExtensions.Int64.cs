...
public static partial class NewtonsoftJsonObjectExtensions {
    ...
    public static long GetInt64(this JObject? json, string propertyName) {
        return JsonTokenUtils.ParseInt64(json?[propertyName]);
    }
    ...
    public static long GetInt64(this JObject? json, string propertyName, long fallback) {
        return JsonTokenUtils.ParseInt64(json?[propertyName], fallback);
    }
    ...
    public static T? GetInt64<T>(this JObject? json, string propertyName, Func<long, T> callback) {
        return JsonTokenUtils.ParseInt64(json?[propertyName], callback);
    }
    ...
    public static long? GetInt64OrNull(this JObject? json, string propertyName) {
        return JsonTokenUtils.ParseInt64OrNull(json?[propertyName]);
    }
    ...
    public static long GetInt64ByPath(this JObject? json, string path) {
        return JsonTokenUtils.ParseInt64(json?.SelectToken(path));
    }
    ...
    public static long GetInt64ByPath(this JObject? json, string path, long fallback) {
        return JsonTokenUtils.ParseInt64(json?.SelectToken(path), fallback);
    }
    ...
    public static T? GetInt64ByPath<T>(this JObject? json, string path, Func<long, T> callback) {
        return JsonTokenUtils.ParseInt64(json?.SelectToken(path), callback);
    }
    ...
    public static long? GetInt64OrNullByPath(this JObject? json, string path) {
        return JsonTokenUtils.ParseInt64OrNull(json?.SelectToken(path));
    }
    ...
    public static bool TryGetInt64(this JObject? json, string propertyName, out long result) {
        return JsonTokenUtils.TryParseInt64(json?[propertyName], out result);
    }
    ...
    public static bool TryGetInt64ByPath(this JObject? json, string path, out long result) {
        return JsonTokenUtils.TryParseInt64(json?.SelectToken(path), out result);
    }
    ...
    public static long[] GetInt64Array(this JObject? json, string propertyName) {
        return JsonTokenUtils.ParseInt64Array(json?[propertyName]);
    }
    ...
    public static long[] GetInt64ArrayByPath(this JObject? json, string path) {
        return JsonTokenUtils.ParseInt64Array(json?.SelectToken(path));
    }

    /// <summary>
    /// Returns the 32-bit integer value of the property with the specified <paramref name="propertyName"/>. If a
    /// matching property isn't found, or the value doesn't match a valid 32-bit integer, an exception is thrown
    /// instead.
    /// </summary>
    /// <param name="json">The parent JSON object.</param>
    /// <param name="propertyName">The name of the property.</param>
    ...
    public static long GetRequiredInt64(this JObject json, string propertyName) {
        JProperty property = json.Property(propertyName) ?? throw new JsonPropertyNotFoundException(json, propertyName);
        if (!JsonTokenUtils.TryParseInt64(property.Value, out long result)) throw new JsonException($"The value of the '{propertyName}' property doesn't match a valid 64-bit integer value.");
        return result;
    }
    ...
    /// <exception cref="JsonPropertyNotFoundException">If a property matching <paramref name="propertyName"/> isn't found.</exception>
    /// <exception cref="JsonException">If the property is found, but the value doesn't match a 64-bit integer.</exception>
    public static TResult GetRequiredInt64<TResult>(this JObject json, string propertyName, Func<long, TResult> callback) where TResult : notnull {
        JProperty property = json.Property(propertyName) ?? throw new JsonPropertyNotFoundException(json, propertyName);
        if (!JsonTokenUtils.TryParseInt64(property.Value, out long result)) throw new JsonException($"The value of the '{propertyName}' property doesn't match a valid 64-bit integer value.");
