...
public static partial class StringExtensions {
    ...
    public static HashSet<long> ToInt64Set(this string? input) {
        return StringUtils.ParseInt64Set(input);
    }
    ...
    /// </returns>
    /// <remarks>Only valid <see cref="long"/> values are included in the returned set. Invalid or unparseable values are ignored.</remarks>
    public static HashSet<long> ToInt64Set(this string? input, params char[] separators) {
        return StringUtils.ParseInt64Set(input, separators);
    }
