...
public static partial class XElementExtensions {
    ...
    public static T GetAttributeValueAsEnum<T>(this XElement element, string expression) where T : struct, Enum {
    ...
    /// <returns>An instance of <typeparamref name="T"/> representing the attribute value.</returns>
    public static T GetAttributeValueAsEnum<T>(this XElement element, string expression, T fallback) where T : struct, Enum {
    ...
    /// in the XPath expression.</param>
    /// <returns>An instance of <typeparamref name="T"/> representing the attribute value.</returns>
    public static T GetAttributeValueAsEnum<T>(this XElement? element, string expression, IXmlNamespaceResolver? resolver) where T : struct, Enum {

        // Get the attribute matching "expression"
        XAttribute? attr = GetAttribute(element, expression, resolver);

        // Convert the attribute value to the type of T
        return attr == null ? default! : EnumUtils.ParseEnum<T>(attr.Value);
    ...
    /// <param name="fallback">An instance of <typeparamref name="T"/> used as fallback.</param>
    /// <returns>An instance of <typeparamref name="T"/> representing the attribute value.</returns>
    public static T GetAttributeValueAsEnum<T>(this XElement element, string expression, IXmlNamespaceResolver? resolver, T fallback) where T : struct, Enum {
