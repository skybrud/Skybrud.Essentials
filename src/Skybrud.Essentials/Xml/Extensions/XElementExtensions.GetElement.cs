...
public static partial class XElementExtensions {
    ...
    /// <returns>An instance of <see cref="XElement"/>, or <see langword="null"/> if <paramref name="name"/> doesn't match any elements.</returns>
    ...
    /// <returns>An instance of <typeparamref name="T"/>, or <see langword="null"/> if <paramref name="name"/> doesn't match any elements.</returns>
