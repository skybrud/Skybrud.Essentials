    ...
    public class TimeHelperTests {
        ...
        public void GetAge() {
            ...
            foreach (var sample in samples) {
                Assert.AreEqual(sample.Age, TimeHelpers.GetAge(sample.Date, fakeNow));
            }
        ...
        public void GetWeekNumber() {
            ...
            foreach (var sample in samples) {
                Assert.AreEqual(sample.Week, TimeHelpers.GetIso8601WeekNumber(sample.Date), "\n\n" + sample.Date + " (TimeHelpers)");
            }
        ...
        public void IsWeekDay() {
            ...
            Assert.AreEqual(true, TimeHelpers.IsWeekday(new DateTime(2014, 2, 10)));
            Assert.AreEqual(true, TimeHelpers.IsWeekday(new DateTime(2014, 2, 11)));
            Assert.AreEqual(true, TimeHelpers.IsWeekday(new DateTime(2014, 2, 12)));
            Assert.AreEqual(true, TimeHelpers.IsWeekday(new DateTime(2014, 2, 13)));
            Assert.AreEqual(true, TimeHelpers.IsWeekday(new DateTime(2014, 2, 14)));
            Assert.AreEqual(false, TimeHelpers.IsWeekday(new DateTime(2014, 2, 15)));
            Assert.AreEqual(false, TimeHelpers.IsWeekday(new DateTime(2014, 2, 16)));
        ...
        public void IsWeekend() {
            ...
            Assert.AreEqual(false, TimeHelpers.IsWeekend(new DateTime(2014, 2, 10)));
            Assert.AreEqual(false, TimeHelpers.IsWeekend(new DateTime(2014, 2, 11)));
            Assert.AreEqual(false, TimeHelpers.IsWeekend(new DateTime(2014, 2, 12)));
            Assert.AreEqual(false, TimeHelpers.IsWeekend(new DateTime(2014, 2, 13)));
            Assert.AreEqual(false, TimeHelpers.IsWeekend(new DateTime(2014, 2, 14)));
            Assert.AreEqual(true, TimeHelpers.IsWeekend(new DateTime(2014, 2, 15)));
            Assert.AreEqual(true, TimeHelpers.IsWeekend(new DateTime(2014, 2, 16)));
        ...
        public void IsLeapYear() {
            ...
            foreach (var sample in samples) {
                ...
                Assert.AreEqual(sample.IsLeapYear, TimeHelpers.IsLeapYear(sample.Year), "\n\n" + sample.Year + " (TimeHelpers)");
                Assert.AreEqual(sample.IsLeapYear, TimeHelpers.IsLeapYear(dt), "\n\n" + sample.Year + " (TimeHelpers)");
        ...
        public void GetUnixTimeFromDateTime() {
            ...
            foreach (var sample in samples) {
                ...
                long local = TimeHelpers.GetUnixTimeFromDateTime(date);
                long utc = TimeHelpers.GetUnixTimeFromDateTime(date.ToUniversalTime());
        ...
        public void GetDateTimeFromUnixTime() {
            ...
            foreach (var sample in samples) {
                ...
                DateTime date = TimeHelpers.GetDateTimeFromUnixTime(sample.Timestamp);
                ...
                string local = dateLocal.ToLocalTime().ToString(TimeHelpers.IsoDateFormat);
                string utc = date.ToUniversalTime().ToString(TimeHelpers.IsoDateFormat);
        ...
        public void GetFirstDayOfMonth() {
            ...
            foreach (var sample in samples) {
                Assert.AreEqual(sample.Expected, TimeHelpers.GetFirstDayOfMonth(sample.Date), "TimeHelpers");
            }
        ...
        public void GetLastDayOfMonth() {
            ...
            foreach (var sample in samples) {
                Assert.AreEqual(sample.Expected, TimeHelpers.GetLastDayOfMonth(sample.Date), "TimeHelpers");
            }
        ...
        public void GetFirstDayOfWeek() {
            ...
            foreach (var sample in samples) {
                ...
                Assert.AreEqual(sample.Monday, TimeHelpers.GetFirstDayOfWeek(sample.Date), "\n\n" + sample.Date + " (TimeHelpers - implicit)");

                Assert.AreEqual(sample.Monday, TimeHelpers.GetFirstDayOfWeek(sample.Date, DayOfWeek.Monday), "\n\n" + sample.Date + " (TimeHelpers - explicit: Monday)");

                Assert.AreEqual(sample.Sunday, TimeHelpers.GetFirstDayOfWeek(sample.Date, DayOfWeek.Sunday), "\n\n" + sample.Date + " (TimeHelpers - explicit: Sunday)");
        ...
        public void GetLastDayOfWeek() {
            ...
            foreach (var sample in samples) {
                ...
                Assert.AreEqual(sample.Monday, TimeHelpers.GetLastDayOfWeek(sample.Date), "\n\n" + sample.Date + " (TimeHelpers - implicit)");

                Assert.AreEqual(sample.Monday, TimeHelpers.GetLastDayOfWeek(sample.Date, DayOfWeek.Monday), "\n\n" + sample.Date + " (TimeHelpers - explicit: Monday)");

                Assert.AreEqual(sample.Sunday, TimeHelpers.GetLastDayOfWeek(sample.Date, DayOfWeek.Sunday), "\n\n" + sample.Date + " (TimeHelpers - explicit: Sunday)");
