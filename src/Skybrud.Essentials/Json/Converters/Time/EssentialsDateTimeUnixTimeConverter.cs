...
namespace Skybrud.Essentials.Json.Converters.Time {
    ...
    /// </summary>
    public class EssentialsDateTimeUnixTimeConverter : JsonConverter {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer) {
            ...
            switch (reader.TokenType) {
                ...
                case JsonToken.Integer:
                    return EssentialsDateTime.FromUnixTimestamp((long) reader.Value);

                case JsonToken.Float:
                    return EssentialsDateTime.FromUnixTimestamp((double) reader.Value);

                case JsonToken.String:
                    Double value;
                    if (Double.TryParse(reader.Value + "", out value)) return EssentialsDateTime.FromUnixTimestamp(value);
