...
namespace Skybrud.Essentials.Json.Converters.Time {
    ...
    public class DateTimeUnixTimeConverter : JsonConverter {
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer) {
            ...
            EssentialsDateTime dt = (DateTime)value;
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer) {
            ...
            switch (reader.TokenType) {
                ...
                case JsonToken.Integer:
                    return TimeHelper.GetDateTimeFromUnixTime((long) reader.Value);

                case JsonToken.Float:
                    return TimeHelper.GetDateTimeFromUnixTime((double) reader.Value);

                case JsonToken.String:
                    Double value;
                    if (Double.TryParse(reader.Value + "", out value)) return TimeHelper.GetDateTimeFromUnixTime(value);
